...
fn periph_macros1() {
    ...
    #[cfg(all(feature = "adc", any(drone_stm32_map = "stm32f303")))]
    {
    ...
    #[cfg(all(feature = "exti", any(drone_stm32_map = "stm32f303")))]
    {
    ...
    #[cfg(all(feature = "tim", any(drone_stm32_map = "stm32f303")))]
    {
    ...
    #[cfg(all(feature = "uart", any(drone_stm32_map = "stm32f413",)))]
    {
